...
//
//public class SampleDayViewBorrowStart extends SampleDayViewAdapter implements DayViewAdapter {
//  @Override
//  public void makeCellView(CalendarCellView parent) {
//    LayoutInflater inflater = LayoutInflater.from(parent.getContext());
//    View layout = inflater.inflate(R.layout.day_view_borrow_start, parent, false);
