...
public class CalendarCellView extends FrameLayout {
  ...
  private static final int[] STATE_RANGE_FIRST_LEND = {
          R.attr.tsquare_state_range_first_lend
  };
  private static final int[] STATE_RANGE_MIDDLE_LEND = {
          R.attr.tsquare_state_range_middle_lend
  };
  private static final int[] STATE_RANGE_LAST_LEND = {
          R.attr.tsquare_state_range_last_lend
  };
  ...
  protected int[] onCreateDrawableState(int extraSpace) {
    ...
    if (rangeState == RangeState.FIRST_LEND) {
      mergeDrawableStates(drawableState, STATE_RANGE_FIRST_LEND);
    } else if (rangeState == RangeState.MIDDLE_LEND) {
      mergeDrawableStates(drawableState, STATE_RANGE_MIDDLE_LEND);
    } else if (rangeState == RangeState.LAST_LEND) {
      mergeDrawableStates(drawableState, STATE_RANGE_LAST_LEND);
    }
